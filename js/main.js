...
const I18N = {
  ...
  cn: {
    ...
    search_ph: '搜索数据资产、术语表、数据字典...',
    quick_access: '快速入口',
    qa_metadata: '元数据', qa_metadata_sub: '术语表与KPI',
    qa_external: '外部数据', qa_external_sub: '第三方来源',
    qa_office: '数据治理办公室', qa_office_sub: '监管团队',
    qa_guide: '用户指南', qa_guide_sub: '操作文档',
    qa_college: '数据学堂', qa_college_sub: '培训与学习',
    qa_apply: '申请数据使用', qa_apply_sub: '申请访问权限',
    metadata_matrix: '元数据矩阵', tag_live: '运行中',
    col_glossaries: '术语表', col_dictionary: '数据字典', col_ref_doc: '参考文档',
    row_sales: '销售', row_customer: '客户', row_supply_chain: '供应链',
    row_finance: '财务', row_marketing: '营销', row_external: '外部数据',
    row_hr: '人力资源', row_public: '公共',
    ...
    chip_all: '全部域', chip_sales: '销售', chip_customer: '客户',
    chip_finance: '财务', chip_supply: '供应链', chip_marketing: '营销',
    chip_external: '外部数据', chip_hr: '人力资源', chip_public: '公共',
    sort_latest: '排序：最新', sort_az: '排序：名称 A-Z', sort_viewed: '排序：最多查看',
    view_grid: '▦ 网格', view_list: '☰ 列表',
    filter_category: '资产类别', filter_glossary: '术语表 / 词条',
    ...
    tc_glossary_title: '术语表 / 词条', tc_glossary_desc: '业务指标、KPI定义、业务术语和缩略词。',
